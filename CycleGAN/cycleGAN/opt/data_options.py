...
class Data_Options(BaseOptions):
    ...
    # neg_model_file = '/home/lipu/Code/GAN/wgan-gp/models/whistle_neg/WGAN_iter50000'
        ...
        # self.parser.add_argument('--output_dir', type=str, default=outbooput_dir,
        ...
        self.parser.add_argument('--pos_data_dir', type=str, required=True, help='Path to positive wgan model')
        self.parser.add_argument('--neg_data_dir', type=str, required=True, help='number of patches to generate')
        self.parser.add_argument('--output_dir', type=str, required=True, help='directory to save data')
