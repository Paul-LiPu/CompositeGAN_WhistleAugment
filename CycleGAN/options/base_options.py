...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--netG_A_residual', action='store_true',
                                 help='only used if which_model_netD==n_layers')
        self.parser.add_argument('--netG_A_rlow', type=float, default=0.1,
                                 help='only used if which_model_netD==n_layers')
        self.parser.add_argument('--netG_A_rhigh', type=float, default=1,
                                 help='only used if which_model_netD==n_layers')
        ...
        self.parser.add_argument('--model', type=str, required=True,
                                 help='whistle_cycle_deepContour_negID, whistle_cycle_deepContour_negID_residual')
        self.parser.add_argument('--dataset_mode', type=str, required=True,
                                 help='chooses how datasets are loaded. [whistle]')
